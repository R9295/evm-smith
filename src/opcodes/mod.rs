...
const OPCODE_FAMILY_COUNT: usize = 11;
...
impl OpcodeFamily {
    const ALL: [Self; OPCODE_FAMILY_COUNT] = [
        Self::Arithmetic,
    ...
    const fn variant_index_at(self, offset: usize) -> usize {
        match self {
            Self::Arithmetic => {
                if offset < 11 {
                    offset
...
fn weighted_variant_index<S: OpcodeSource>(
    source: &mut S,
